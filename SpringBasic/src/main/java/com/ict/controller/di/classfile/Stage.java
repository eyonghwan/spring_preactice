...
@Component
public class Stage {
	// 무대는 가수가 있어야 성립하며, 그때 그때 다른 가수를 세울 수도 있습니다.
	...
	// 4버전까지 @Autiwired 사용시  아무 작업도 하지 않는 디폴트 생성자가 추가되어야 합니다.
	// 5버전에서도 @Qualifier 어노테이션 사용 시 디폴트 생성자가 필요합니다.
	public Stage() {}
	
	public Stage(Singer singer) {
		this.singer = singer; // 무대에 설 가수를 입력해샤야 생성자가 호출되도록 처리
	}
